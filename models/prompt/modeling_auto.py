...
# Instead of loading the BART from the transformers==4.9.2, we choose to load from our own prefix-tuning version.
...
# Instead of loading the MBART from the transformers==4.9.2, we choose to load from our own prefix-tuning version.
...
# Instead of loading the MT5 from the transformers==4.9.2, we choose to load from our own prefix-tuning version.
...
# Instead of loading the T5 from the transformers==4.9.2, we choose to load from our prefix-tuning version.
