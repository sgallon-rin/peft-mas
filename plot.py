...
# 添加标题和标签
plt.title('ROUGE-L scores of mBART$_\mathdefault{LARGE}$ on XL-Sum', fontsize=14)
# plt.xlabel('')
# plt.ylabel('')
...
plt.grid(axis='y', linestyle='--', alpha=0.5)
plt.title('ROUGE-L scores of mT5$_\mathdefault{BASE}$ on XL-Sum', fontsize=14)
plt.tick_params(labelsize=11)
plt.xticks(x+width, languages, fontsize=14)
plt.ylabel("ROUGE-L", fontsize=12)
...
plt.title('ROUGE-L scores of mBART$_\mathdefault{LARGE}$ on XL-Sum with optimal prefix lengths', fontsize=14)
...
plt.grid(axis='y', linestyle='--', alpha=0.5)
plt.title('ROUGE-L scores of mBART$_\mathdefault{LARGE}$ on few-shot XL-Sum with optimal prefix lengths', fontsize=13)
plt.tick_params(labelsize=11)
plt.xticks(x+width/2, languages, fontsize=14)
plt.ylabel("ROUGE-L", fontsize=12)
plt.legend(fontsize=11)
